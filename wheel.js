...
export function spinWheel(canvasElement, restaurants, durationSeconds, onSpinCompleteCallback) {
    ...
    // durationSeconds is passed from main.js; fall back to DOM slider if somehow not provided
    if (typeof durationSeconds !== 'number' || isNaN(durationSeconds)) {
        ...
        durationSeconds = parseFloat(spinDurationRange ? spinDurationRange.value : 5);
    }
